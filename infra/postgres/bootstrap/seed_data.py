    ...
    try:
        ...
        session.add(
            Profile(
                ...
                headline_nl=PROFILE_ROW.get('headline_nl'),
                short_intro=PROFILE_ROW['short_intro'],
                short_intro_nl=PROFILE_ROW.get('short_intro_nl'),
                long_bio=PROFILE_ROW['long_bio'],
                long_bio_nl=PROFILE_ROW.get('long_bio_nl'),
                ...
                cta_secondary_label_nl=PROFILE_ROW.get('cta_secondary_label_nl'),
        ...
        for project in PROJECT_ROWS:
            ...
            session.add(
                Project(
                    ...
                    slug=project['slug'],
                    title=project['title'],
                    title_nl=project.get('title_nl'),
                    teaser=project['teaser'],
                    teaser_nl=project.get('teaser_nl'),
                    summary=project['summary'],
                    summary_nl=project.get('summary_nl'),
                    description_markdown=project['description_markdown'],
                    description_markdown_nl=project.get('description_markdown_nl'),
                    ...
                    duration_label_nl=project.get('duration_label_nl'),
                    status=project['status'],
                    status_nl=project.get('status_nl'),
        ...
        for project in PROJECT_ROWS:
            session.add(
                ProjectImage(
                    ...
                    alt_text_nl=project.get('cover_image_alt_nl'),
                    sort_order=0,
                    is_cover=True,
                )
            )
        ...
        for post in BLOG_POST_ROWS:
            session.add(
                BlogPost(
                    ...
                    slug=post['slug'],
                    title=post['title'],
                    title_nl=post.get('title_nl'),
                    excerpt=post['excerpt'],
                    excerpt_nl=post.get('excerpt_nl'),
                    content_markdown=post['content_markdown'],
                    content_markdown_nl=post.get('content_markdown_nl'),
                    cover_image_file_id=_seed_uuid(post.get('cover_image_file_id')),
                    cover_image_alt=post.get('cover_image_alt'),
                    cover_image_alt_nl=post.get('cover_image_alt_nl'),
                    ...
                    seo_title_nl=post.get('seo_title_nl'),
                    seo_description=post.get('seo_description'),
                    seo_description_nl=post.get('seo_description_nl'),
