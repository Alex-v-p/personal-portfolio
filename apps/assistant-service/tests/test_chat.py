...
def test_provider_daily_generation_cap_forces_fallback(tmp_path: Path, monkeypatch) -> None:
    ...
    assert "I don't have enough detail to answer that confidently yet. You can ask me about Alex's projects, experience, skills, blog posts, or overall profile." in second.json()['message']
