...
IMPORT_TABLES: tuple[CsvTableConfig, ...] = (
    ...
    CsvTableConfig('blog_protected_document_groups.csv', BlogProtectedDocumentGroup, 'protected blog document groups'),
    CsvTableConfig('blog_protected_documents.csv', BlogProtectedDocument, 'protected blog documents'),
