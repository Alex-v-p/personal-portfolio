...
class Project(TimestampMixin, Base):
    ...
    duration_label_nl: Mapped[str | None] = mapped_column(String(120))
    status: Mapped[str] = mapped_column(String(120), nullable=False)
    status_nl: Mapped[str | None] = mapped_column(String(120))
    state: Mapped[ProjectState] = mapped_column(SqlEnum(ProjectState, native_enum=False), nullable=False)
    is_featured: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    is_card_popup_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class ProjectImage(Base):
    ...
    alt_text_nl: Mapped[str | None] = mapped_column(String(255))
    sort_order: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
